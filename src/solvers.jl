solvers_const = Dict(
    ...
    :ARCLDLt_HO_Sham => (HessDense, PDataLDLt, (v, w, x, y, z) -> solve_modelARCDiag_HO(v, w, x, y, z, ho_correction = :Shamanskii, λfact = 100.0), ()),
    :ARCLDLt_HO_vs_Nwt => (HessDense, PDataLDLt, (v, w, x, y, z) -> solve_modelARCDiag_HO_vs_Nwt(v, w, x, y, z, λfact = 100.0, nwt_res_fact = 0.8), ()),
    ...
    :ARCqKdense => (HessDense, PDataKARC, solve_modelKARC, [(:shifts => 10.0 .^ (collect(-20.0:1.0:20.0)))]),
    :ARCqKOp => (HessOp, PDataKARC, solve_modelKARC, [:shifts => 10.0 .^ (collect(-20.0:1.0:20.0))]),
    :ARCqKsparse => (HessSparse, PDataKARC, solve_modelKARC, [:shifts => 10.0 .^ (collect(-20.0:1.0:20.0))]),
    ...
    :TRLDLt_HO_vs_Nwt_λ => (HessDense, PDataLDLt, (v, w, x, y, z) -> solve_modelTRDiag_HO_vs_Nwt_λ(v, w, x, y , z; ho_correction = :Shamanskii, nwt_res_fact = 0.25, λfact = 1.0), ()),
